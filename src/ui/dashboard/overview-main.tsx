    ...
    <>
      <section className="grid w-full justify-items-stretch  lg:grid-cols-12  xxl:grid-cols-11 gap-[2.4rem] xl:gap-[2rem] ">
        ...
        <div className="flex flex-col lg:col-span-8 xl:col-span-8 xxl:col-span-8 gap-[2.4rem]">
          <div className=" gap-[2rem] lg:h-[32rem] flex flex-col lg:flex-row items-stretch">
            <IncomeAnalysis />
            <Savings />
          </div>
          <div className="col-span-8  flex  flex-col lg:flex-row lg:items-start items-start gap-[2rem] border-black">
            <ExpenseCategory />
